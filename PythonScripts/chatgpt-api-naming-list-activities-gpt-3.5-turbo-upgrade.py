    ...
    for i in range((10)):
        ...
        response = client.chat.completions.create(
          ...
          messages=[
            {
              "role": "system",
              "content": "You will be provided by a list of activities and your task is to give me a short single specific name that describes this list of activities combined together:"
            },
            {
              "role": "user",
